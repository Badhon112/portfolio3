    ...
    <div className="Work flex flex-col items-center pt-16 overflow-y-hidden min-h-screen" id="Services">
      ...
      <div className="mt-2 flex flex-col items-center">
        <div className="top flex space-x-20 overflow-hidden ">
          <div className="flex six relative flex-col items-center w-60 h-60  rounded-3xl   ">
            <img
              src={Image.Ui}
              alt="Figma"
          ...
          <div className="flex two flex-col items-center w-60 h-60  rounded-3xl ">
            <img
          ...
          <div className="flex three flex-col items-center w-60 h-60  rounded-3xl  ">
            <img
              src={Image.Mern}
              alt="Figma"
              className="w-10 h-10 mt-2 rounded-full animate-bounce"
          ...
          <div className="flex four flex-col items-center w-60 h-60  rounded-3xl  ">
            <img
        ...
        <div className="bottom mt-5 flex space-x-20  overflow-hidden">
          <div className="flex five flex-col items-center w-60 h-60  rounded-3xl ">
            <img
              src={Image.React}
              alt="Figma"
              className="w-10 h-10 mt-2 rounded-full animate-spin"
          ...
          <div className="flex six flex-col items-center w-60 h-60  rounded-3xl ">
            <img
              src={Image.Nodejs}
              alt="Figma"
              className="w-10 h-10 mt-2 rounded-full animate-bounce"
          ...
          <div className="flex seven flex-col items-center w-60 h-60  rounded-3xl  ">
            <img
              src={Image.Eco}
              alt="Figma"
              className="w-10 h-10 mt-2 rounded-full animate-pulse"
          ...
          <div className="flex eight flex-col items-center w-60 h-60  rounded-3xl  ">
            <img
              src={Image.SM}
              alt="Figma"
              className="w-10 h-10 mt-2 rounded-full animate-pulse"
